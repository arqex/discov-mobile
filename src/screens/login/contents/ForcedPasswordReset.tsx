...
export default class ForcedPasswordReset extends React.Component<ScreenProps> {
	state = {
		password: '',
		code: '',
		loading: false
			...
			<View style={styles.container}>
				<View style={styles.form}>
					...
					<View style={styles.marginBottom}>
						<Text color="#fff">
							You need to select a new password for your account before continue using discov.
						</Text>
					</View>
					<View style={styles.marginBottom}>
	...
	_resetPassword = connectionRequiredMethod( () => {
		...
		this.props.actions.auth.completeNewPassword( this.state.password )
			.then( res => {
		...
		;
	}, 'Need an internet connection to update the password.')
