// This storage adapter is needed just because there is a bug in amplify
// that doesn't store the session. Delete when it's fixed:
// https://github.com/aws-amplify/amplify-js/issues/4351
